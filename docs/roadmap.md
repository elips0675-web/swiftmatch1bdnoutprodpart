...
- Открыт: сверка поведения jsdom/localStorage на Node 25 (dev) vs 22-alpine (Docker) — docker на dev-машине не установлен, сверка переносится на staging при наличии.
