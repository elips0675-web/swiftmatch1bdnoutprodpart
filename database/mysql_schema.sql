-- =============================================================
-- SwiftMatch - Full MySQL Schema (regenerated from live DB, этап 116)
-- Covers: auth, profiles, matching, chats, groups, feeds,
--         notifications, admin, analytics, polls, icebreakers,
--         75 tables (incl. migration-created: hangouts, partners,
--         experiments, refresh_tokens, event_tickets and others)
--
...
CREATE TABLE `event_tickets` (
  ...
  `user_id` int unsigned NOT NULL,
  `partner_order_id` int unsigned DEFAULT NULL,
  ...
  KEY `idx_evtick_offer` (`offer_id`),
  KEY `idx_evtick_user` (`user_id`),
...
CREATE TABLE `group_post_comments` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
  KEY `idx_group_post_comments_post` (`post_id`,`created_at`),
...
CREATE TABLE `group_post_likes` (
  ...
  KEY `user_id` (`user_id`),
  KEY `idx_group_post_likes_post` (`post_id`),
...
CREATE TABLE `group_posts` (
  ...
  CONSTRAINT `group_posts_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `chat_groups` (`id`) ON DELETE CASCADE,
...
CREATE TABLE `hangouts` (
  ...
  KEY `idx_hangouts_view_count` (`view_count`),
...
CREATE TABLE `icebreaker_questions` (
  ...
  `sort_order` tinyint unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_icebreaker_q` (`theme_id`,`sort_order`),
...
CREATE TABLE `user_photos` (
  ...
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `deleted_at` timestamp NULL DEFAULT NULL,
  `moderation_status` varchar(20) COLLATE utf8mb4_unicode_ci DEFAULT 'approved',
