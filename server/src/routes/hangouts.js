...
const respondLimiter = rateLimit({ store: getRateLimitStore(), windowMs: 60_000, max: 300, message: { message: 'Too many responses' } })
const createLimiter = rateLimit({ store: getRateLimitStore(), windowMs: 60_000, max: Number(process.env.HANGOUT_CREATE_RATE_MAX || 50), message: { message: 'Too many hangouts created' } })
...
const likeLimiter = rateLimit({ store: getRateLimitStore(), windowMs: 60_000, max: 300, message: { message: 'Too many likes' } })
const joinLimiter = rateLimit({ store: getRateLimitStore(), windowMs: 60_000, max: 300, message: { message: 'Too many joins' } })
const checkinLimiter = rateLimit({ store: getRateLimitStore(), windowMs: 60_000, max: 300, message: { message: 'Too many check-ins' } })
...
const hangoutTicketLimiter = rateLimit({ store: getRateLimitStore(), windowMs: 60_000, max: 100, message: { message: 'Too many ticket requests' } })
...
const boostLimiter = rateLimit({ store: getRateLimitStore(), windowMs: 60_000, max: 100, message: { message: 'Too many boost requests' } })
...
const suggestLimiter = rateLimit({ store: getRateLimitStore(), windowMs: 60_000, max: 300, message: { message: 'Too many suggest requests' } })
